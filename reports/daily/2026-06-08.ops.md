...
| 宝玉的分享 | ⚠️ 过期（newest item is 382.7h old, exceeds 336h threshold） |
...
| Dario Amodei (Twitter) | ⚠️ 过期（newest item is 1468.4h old, exceeds 720h threshold） |
| Demis Hassabis (Twitter) | ✅ 正常（窗口内 0 文） |
| Andrej Karpathy (Twitter) | ⚠️ 过期（newest item is 463.6h old, exceeds 336h threshold） |
